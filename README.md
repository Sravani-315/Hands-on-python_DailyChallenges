...
| Day 8 | Autonomous Smart City Risk Analyzer | Simulates traffic, air, and energy data, classifies zones, computes risk scores using NumPy and Pandas, detects risk patterns, and includes Doraemon-based personalized authentication.
| Day 9 | Multi-Level Data Replication & Risk Analysis | Processes nested zone data, simulates replication using assignment, shallow and deep copy, detects hidden corruption, computes logarithmic risk scores, performs NumPy–Pandas analysis, manual correlation, anomaly detection, and includes Doraemon gadget-based authentication with dataset personalization.
| Day 10| Data Replication & Corruption Detection | Simulates nested data replication, demonstrates shallow vs deep copy behavior, detects corruption, computes risk scores, performs statistical analysis, and includes Doraemon-based authentication with dataset personalization.
